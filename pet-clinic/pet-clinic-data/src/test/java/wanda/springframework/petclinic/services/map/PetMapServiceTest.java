...
class PetMapServiceTest {
  ...
  void setUp() {
    ...
    petMapService = new PetMapService(petTypeService);
    petMapService.save(Pet.builder().id(petId).petType(new PetType("Dog")).build());
  }
  ...
  void saveExistingId() {
    Long id = 2L;
    Pet pet2 = Pet.builder().id(id).petType(new PetType("Dog")).build();
  ...
  @Test
  void saveNoId() {
    Pet savedPet = petMapService.save(Pet.builder().petType(new PetType("Dog")).build());
